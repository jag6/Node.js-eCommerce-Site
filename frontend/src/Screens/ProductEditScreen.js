import { getProduct, updateProduct, uploadProductImage } from "../Api/apiProducts.js";
    ...
    after_render:() => {
        ...
        document.getElementById("edit-product-form").addEventListener('submit', async (e) => {
            ...
            if(data.error) {
                ...
                showMessage('Product Update Successful', () => {
    ...
    render: async () => {
        ...
        <div class="edit-screen content">
            <div class="back-to-result">
                <a href="/#/productlist"><i class="arrow-left"></i>Back to Product List</a>
            </div>
            <div class="form-container">
                <form id="edit-product-form" class="form">
                    ...
                    <textarea form="edit-product-form" type="text" name="description" id="description" cols="30" rows="10" value="${product.description}">${product.description}</textarea>
